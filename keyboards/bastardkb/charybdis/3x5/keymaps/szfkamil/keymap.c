...
#define ______________HOME_ROW_GASC_L______________ KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX // custom
#define ______________HOME_ROW_GASC_R______________ XXXXXXX, KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI // custom
/*
 ...
 *
 * Expects a 10-key per row layout.  Adds support for GASC (Gui, Alt, Ctl, Shift)
